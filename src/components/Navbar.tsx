      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <a href="/#home" className="text-xl font-bold text-blue-900 hover:text-blue-700 transition-colors">
              WorkMasters
            </a>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="/#programs" className="text-gray-700 hover:text-blue-600 transition-colors font-medium">
              Programs
            </a>
            <a href="/#impact" className="text-gray-700 hover:text-blue-600 transition-colors font-medium">
              Impact
            </a>
